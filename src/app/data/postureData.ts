...
The head shifts forward from its natural position`,
    ...
    exerciseList: [
      ...
      { id: 'fh-b3', name: 'Upper Trapezius Stretch', difficulty: 'beginner', duration: 40, emoji: '🙆', iconType: 'neck', youtubeUrl: 'https://www.youtube.com/shorts/Kvqlsyo28N8',
        description: 'Reduces upper-trap tension that keeps the neck and shoulders pulled into the forward-head pattern.',
        instructions: ['Sit or stand tall with shoulders relaxed and chest open', 'Anchor one hand under your thigh or hold the edge of a chair', 'Gently tilt your opposite ear toward your shoulder until you feel a stretch along the side of the neck', 'Hold 20 seconds while breathing slowly and keeping the shoulder down', 'Return to center with control and repeat on the other side'] },
      // ── Medium ────────────────────────────────────────────────
      { id: 'fh-m1', name: 'Chin Tuck Floor Angels', difficulty: 'medium', duration: 45, emoji: '🪄', iconType: 'neck', youtubeUrl: 'https://www.youtube.com/shorts/tmZ6ufhHeNA',
      ...
      { id: 'fh-m3', name: 'Wall Lean Chin Tuck', difficulty: 'medium', duration: 45, emoji: '🧱', iconType: 'neck', youtubeUrl: 'https://www.youtube.com/shorts/uSTnwYMsZ7A',
      ...
      { id: 'fh-h2', name: 'Chin Tuck Neck Bridge', difficulty: 'hard', duration: 55, emoji: '🌉', iconType: 'neck', youtubeUrl: 'https://www.youtube.com/shorts/M0Dg9ncnoao',
      ...
      { id: 'fh-h3', name: 'Banded Chin Tucks', difficulty: 'hard', duration: 55, emoji: '💫', iconType: 'neck', youtubeUrl: 'https://www.youtube.com/shorts/LthybLqjstI', requiresEquipment: true,
...
This creates functional winging (not nerve damage, but poor control).`,
    ...
    exerciseList: [
      // ── Beginner ──────────────────────────────────────────────
      { id: 'ws-b1', name: 'Quadruped Scapular Push', difficulty: 'beginner', duration: 35, emoji: '🐾', iconType: 'shoulder', youtubeUrl: 'https://www.youtube.com/shorts/bujO-PR9Zpo',
        description: 'Builds serratus activation in a supported hands-and-knees position to improve scapular control.',
        instructions: ['Start on all fours with hands under shoulders and knees under hips', 'Keep elbows straight and neck neutral throughout the movement', 'Let your chest sink slightly between the shoulders without bending the arms', 'Press the floor away until the upper back rounds gently and the shoulder blades spread apart', 'Move slowly for 10-12 reps while keeping the core braced'] },
      { id: 'ws-b2', name: 'Air Angel', difficulty: 'beginner', duration: 35, emoji: '🪄', iconType: 'shoulder', youtubeUrl: 'https://www.youtube.com/shorts/g1YnTIYRAxo',
      ...
      { id: 'ws-b3', name: 'Floor Angel', difficulty: 'beginner', duration: 40, emoji: '🪄', iconType: 'back', youtubeUrl: 'https://www.youtube.com/shorts/1Qy9ZazKYWg',
        description: 'Floor contact helps train smooth scapular motion while giving clear feedback for alignment.',
        instructions: ['Lie on your back with knees bent and arms in a goalpost position', 'Press the backs of your hands and forearms gently into the floor', 'Slowly slide your arms overhead as far as you can without losing contact', 'Pause briefly, then return with control to the start position', 'Complete 8-10 slow reps while keeping ribs relaxed'] },
      // ── Medium ────────────────────────────────────────────────
      { id: 'ws-m1', name: 'Side Lean Wall Slide', difficulty: 'medium', duration: 45, emoji: '🧱', iconType: 'shoulder', youtubeUrl: 'https://www.youtube.com/shorts/3MuocTDKb-k',
        description: 'Challenges serratus and upward rotation with a wall-supported side-lean pattern.',
        instructions: ['Stand sideways next to a wall with the forearm of the wall-side arm resting on it', 'Lean gently into the wall while keeping your ribs down and core tight', 'Slide that forearm upward as you reach through the shoulder blade', 'Keep pressure into the wall and avoid shrugging the shoulder toward the ear', 'Lower with control and perform 8-10 reps per side'] },
      { id: 'ws-m2', name: 'Wall Angel', difficulty: 'medium', duration: 45, emoji: '🧱', iconType: 'back', youtubeUrl: 'https://www.youtube.com/shorts/AVFrTWQKHJA',
        description: 'Scapular upward rotation against the wall targets serratus and lower trapezius together.',
        instructions: ['Stand with your back flat against the wall, feet 6 inches from the base', 'Press head, upper back, and hips firmly into the wall', 'Raise arms to a 90° goalpost position, backs of hands on wall', 'Slowly slide arms overhead while keeping all contact points on the wall', 'Lower with full control for 10 reps while keeping ribs down'] },
      { id: 'ws-m3', name: 'Scapular Flutters', difficulty: 'medium', duration: 45, emoji: '🪽', iconType: 'shoulder', youtubeUrl: 'https://www.youtube.com/shorts/-ZE0J-ro3r8',
        description: 'Quick controlled pulses improve scapular endurance and shoulder blade positioning.',
        instructions: ['Lie face down or stand hinged slightly forward with arms lifted out to the sides', 'Keep elbows soft and neck long', 'Make small fast fluttering movements from the shoulder blades, not the wrists', 'Focus on keeping the shoulder blades stable and away from the ears', 'Continue for 20-30 seconds with smooth breathing and control'] },
      // ── Hard ──────────────────────────────────────────────────
      { id: 'ws-h1', name: 'Bear Crawl Scapular Push Up', difficulty: 'hard', duration: 55, emoji: '🐻', iconType: 'shoulder', youtubeUrl: 'https://www.youtube.com/shorts/hi0fKb6EaXo',
        description: 'High-demand serratus strengthening in a hovering bear position improves winging control under load.',
        instructions: ['Start in a bear crawl position with knees hovering a few inches off the floor', 'Keep hands under shoulders and spine neutral', 'Without bending the elbows, let the chest sink slightly between the shoulders', 'Press the floor away strongly until the upper back rounds and shoulder blades spread apart', 'Perform 8-10 controlled reps while keeping the knees hovering'] },
      { id: 'ws-h2', name: 'Quadruped Scapular Circles', difficulty: 'hard', duration: 55, emoji: '🔄', iconType: 'shoulder', youtubeUrl: 'https://www.youtube.com/shorts/LmfhXfoKGlI',
        description: 'Circular scapular control improves shoulder blade coordination through multiple directions.',
        instructions: ['Begin on all fours with elbows straight and core engaged', 'Shift through protraction, elevation, retraction, and depression to draw a slow circle with the shoulder blades', 'Make the movement come from the scapulae instead of bending the arms', 'Complete several smooth circles in one direction, then reverse', 'Keep the neck relaxed and move slowly with control'] },
      { id: 'ws-h3', name: 'Elevated Scapular Push Up', difficulty: 'hard', duration: 55, emoji: '⬆️', iconType: 'shoulder', youtubeUrl: 'https://www.youtube.com/shorts/CkZ-D7cFR8I',
        description: 'An incline position lets you load scapular protraction and retraction more aggressively without losing form.',
        instructions: ['Place hands on an elevated bench, box, or sturdy surface and step back into a plank', 'Keep elbows locked and body in a straight line', 'Let the chest lower slightly between the shoulders while keeping the core tight', 'Push the surface away until the shoulder blades spread fully apart', 'Repeat 10-12 slow reps without shrugging the shoulders'] },
    ],
...
The pelvis tilts forward from its neutral position`,
    ...
    exerciseList: [
      // ── Beginner ──────────────────────────────────────────────
      { id: 'apt-b1', name: 'Standing Pelvic Tilt', difficulty: 'beginner', duration: 35, emoji: '🧍', iconType: 'core', youtubeUrl: 'https://www.youtube.com/shorts/MnvcnjCf710',
        description: 'Transfers pelvic tilt control to a functional standing position.',
        instructions: ['Stand with your back against a wall, feet 4-6 inches forward', 'Notice the gap between your lower back and the wall', 'Gently tuck your pelvis and lightly squeeze your glutes', 'Hold 5 seconds while keeping ribs stacked over hips', 'Release and repeat 10-12 reps with control'] },
      { id: 'apt-b2', name: 'Supine Pelvic Tilt', difficulty: 'beginner', duration: 35, emoji: '🔄', iconType: 'core', youtubeUrl: 'https://www.youtube.com/shorts/DqqUIfMuDX4',
        description: 'Teaches posterior tilt awareness in a supported position with gravity removed.',
        instructions: ['Lie on your back with knees bent and feet flat', 'Breathe out and gently flatten your lower back into the floor', 'Engage your abs lightly as the pelvis rotates backward', 'Hold for 5 seconds without pushing through the neck or shoulders', 'Relax and repeat 12-15 reps'] },
      { id: 'apt-b3', name: 'Pelvic Rocks', difficulty: 'beginner', duration: 40, emoji: '🌀', iconType: 'hip', youtubeUrl: 'https://www.youtube.com/shorts/QEZzyYGPCAQ',
        description: 'Gently rocks the pelvis to improve awareness and reduce stiffness around the lower back and hips.',
        instructions: ['Lie on your back with knees bent and feet planted comfortably', 'Slowly tilt the pelvis forward and backward in a small rocking motion', 'Move smoothly between a gentle arch and a gentle flattening of the lower back', 'Keep the movement controlled and pain-free while breathing normally', 'Continue for 30-40 seconds focusing on smooth pelvic motion'] },
      // ── Medium ────────────────────────────────────────────────
      { id: 'apt-m1', name: 'Unilateral Frog Stretch', difficulty: 'medium', duration: 45, emoji: '🐸', iconType: 'hip', youtubeUrl: 'https://www.youtube.com/shorts/KIFqxyyB9Sc',
        description: 'Targets tight inner thigh and hip tissues one side at a time to help the pelvis settle into a better position.',
        instructions: ['Start on all fours and extend one leg out to the side with the knee bent', 'Keep the opposite knee under your hip and hands under your shoulders', 'Rock your hips gently backward until you feel a stretch through the inner thigh and groin', 'Pause and breathe slowly without forcing the range', 'Repeat for 20-30 seconds, then switch sides'] },
      { id: 'apt-m2', name: 'Wall Lean Plank', difficulty: 'medium', duration: 45, emoji: '🧱', iconType: 'core', youtubeUrl: 'https://www.youtube.com/shorts/eGc5eLQ0KPA',
        ...
        instructions: ['Face a wall and place both forearms flat against it at shoulder height', 'Step feet back until your body forms a straight inclined plank', 'Engage your core and avoid letting the lower back arch', 'Maintain a gentle posterior pelvic tilt throughout the hold', 'Hold 20-30 seconds, rest, and repeat'] },
      { id: 'apt-m3', name: 'Swimmers', difficulty: 'medium', duration: 45, emoji: '🏊', iconType: 'back', youtubeUrl: 'https://www.youtube.com/shorts/oOaXVYntkfA',
        description: 'Prone extension with glute activation helps restore posterior-chain support against anterior tilt.',
        instructions: ['Lie face down on a mat with arms extended overhead', 'Lift your right arm and left leg slightly off the floor', 'Lower with control and switch to the opposite side', 'Move in a smooth alternating pattern without overarching the lower back', 'Complete 8-10 reps per side while keeping glutes engaged'] },
      // ── Hard ──────────────────────────────────────────────────
      { id: 'apt-h1', name: 'Split Squat Pelvic Tilts', difficulty: 'hard', duration: 55, emoji: '🦵', iconType: 'hip', youtubeUrl: 'https://www.youtube.com/shorts/DBDwIVPWZms',
        description: 'Hip flexor lengthening combined with tilt control in a functional split stance.',
        instructions: ['Stand in a split stance with one foot forward and one foot back', 'Lower your back knee toward the floor into a split squat', 'At the bottom, tuck the pelvis slightly and squeeze the glute of the back leg', 'Hold that position briefly while feeling the front of the hip open', 'Rise with control and repeat 8-10 reps per side'] },
      { id: 'apt-h2', name: 'Adductor Squeeze Crunch', difficulty: 'hard', duration: 55, emoji: '💥', iconType: 'core', youtubeUrl: 'https://www.youtube.com/shorts/MvkZbVhn0g0',
        description: 'Combines inner-thigh activation with abdominal bracing to improve pelvic control.',
        instructions: ['Lie on your back with knees bent and place a pillow or ball between your knees', 'Gently squeeze the object to engage the inner thighs', 'Exhale and lift into a small crunch while keeping the lower back controlled', 'Lower slowly without losing the squeeze between the knees', 'Repeat 10-12 reps with steady breathing'] },
      { id: 'apt-h3', name: 'Crossed Leg Forward Stretch', difficulty: 'hard', duration: 60, emoji: '🧘', iconType: 'hip', youtubeUrl: 'https://www.youtube.com/shorts/575CtR',
        description: 'A forward-fold variation that targets hip and posterior-chain tightness that can feed into pelvic imbalance.',
        instructions: ['Stand tall and cross one leg lightly in front of the other', 'Hinge forward from the hips while keeping the spine long', 'Reach toward the floor only as far as you can without straining', 'Breathe into the stretch and keep most of the weight balanced through both feet', 'Hold briefly, return with control, and switch the leg position'] },
    ],
