...
The head shifts forward from its natural position`,
    ...
    exerciseList: [
      ...
      { id: 'fh-h2', name: 'Banded Chin Tucks', difficulty: 'hard', duration: 55, emoji: '💫', iconType: 'neck', youtubeUrl: 'https://www.youtube.com/shorts/LthybLqjstI',
...
This creates functional winging (not nerve damage, but poor control).`,
    ...
    exerciseList: [
      ...
      { id: 'ws-m2', name: 'Face Pulls', difficulty: 'medium', duration: 45, emoji: '🎯', iconType: 'shoulder', youtubeUrl: 'https://www.youtube.com/shorts/e8APCEYbpVY',
      ...
      { id: 'ws-m3', name: 'Reverse Fly', difficulty: 'medium', duration: 45, emoji: '💪', iconType: 'shoulder', youtubeUrl: 'https://www.youtube.com/shorts/OUn0pOyxqwE',
      ...
      { id: 'ws-h2', name: 'Banded Rainbows', difficulty: 'hard', duration: 55, emoji: '🌈', iconType: 'shoulder', youtubeUrl: 'https://www.youtube.com/shorts/uUFnCndr5JU',
      ...
      { id: 'ws-h3', name: 'Archer Rows', difficulty: 'hard', duration: 55, emoji: '🏹', iconType: 'back', youtubeUrl: 'https://www.youtube.com/shorts/YCjnjRQY3cU',
      ...
      { id: 'ws-h5', name: 'Eccentric Reverse Fly', difficulty: 'hard', duration: 60, emoji: '🔄', iconType: 'shoulder', youtubeUrl: 'https://www.youtube.com/shorts/74wyKVYgETU',
...
The pelvis tilts forward from its neutral position`,
    ...
    exerciseList: [
      ...
      { id: 'apt-h2', name: 'Archer Rows', difficulty: 'hard', duration: 55, emoji: '🏹', iconType: 'back', youtubeUrl: 'https://www.youtube.com/shorts/YCjnjRQY3cU',
      ...
      { id: 'apt-h3', name: 'Banded Rainbows', difficulty: 'hard', duration: 60, emoji: '🌈', iconType: 'shoulder', youtubeUrl: 'https://www.youtube.com/shorts/uUFnCndr5JU',
  ...
  },
  {
    ...
    exerciseList: [
      ...
      { id: 'rs-m3', name: 'Reverse Fly', difficulty: 'medium', duration: 45, emoji: '💪', iconType: 'shoulder', youtubeUrl: 'https://www.youtube.com/shorts/OUn0pOyxqwE',
      ...
      { id: 'rs-m4', name: 'Face Pulls', difficulty: 'medium', duration: 45, emoji: '🎯', iconType: 'shoulder', youtubeUrl: 'https://www.youtube.com/shorts/e8APCEYbpVY',
      ...
      { id: 'rs-h2', name: 'Eccentric Reverse Fly', difficulty: 'hard', duration: 55, emoji: '🔄', iconType: 'shoulder', youtubeUrl: 'https://www.youtube.com/shorts/74wyKVYgETU',
      ...
      { id: 'rs-h3', name: 'Archer Rows', difficulty: 'hard', duration: 55, emoji: '🏹', iconType: 'back', youtubeUrl: 'https://www.youtube.com/shorts/YCjnjRQY3cU',
      ...
      { id: 'rs-h5', name: 'Banded Rainbows', difficulty: 'hard', duration: 60, emoji: '🌈', iconType: 'shoulder', youtubeUrl: 'https://www.youtube.com/shorts/uUFnCndr5JU',
        description: 'Full-arc overhead resistance challenges scapular control through the complete shoulder range.',
        instructions: ['Stand tall with a resistance band anchored below your feet', 'Hold the band in both hands, arms extended above your head', 'Arc both arms in a wide rainbow from one side down through center to the other', 'Control the deceleration — resist the pull on the return arc', '10–12 full arcs, maintaining upright posture throughout'] },
      { id: 'rs-h6', name: 'Seated Deconstructed Face Pull', difficulty: 'hard', duration: 60, emoji: '🏹', iconType: 'shoulder', youtubeUrl: 'https://www.youtube.com/shorts/drJnKgXoRQc',
  ...
  },
  {
    ...
    exerciseList: [
      ...
      { id: 'ky-m2', name: 'Wall Angel', difficulty: 'medium', duration: 45, emoji: '🧱', iconType: 'back', youtubeUrl: 'https://www.youtube.com/shorts/AVFrTWQKHJA',
        ...
        instructions: ['Stand with your back flat against the wall, feet 6 inches from the base', 'Press head, upper back, and hips firmly into the wall', 'Raise arms to a 90° goalpost position, backs of hands on wall', 'Slowly slide arms overhead while keeping all contact points on the wall', 'Lower with full control — 10 reps, keep ribs down throughout'] },
      { id: 'ky-m3', name: 'Reverse Fly', difficulty: 'medium', duration: 45, emoji: '💪', iconType: 'shoulder', youtubeUrl: 'https://www.youtube.com/shorts/OUn0pOyxqwE',
      ...
      { id: 'ky-h3', name: 'Archer Rows', difficulty: 'hard', duration: 55, emoji: '🏹', iconType: 'back', youtubeUrl: 'https://www.youtube.com/shorts/YCjnjRQY3cU',
      ...
      { id: 'ky-h4', name: 'Eccentric Reverse Fly', difficulty: 'hard', duration: 55, emoji: '🔄', iconType: 'shoulder', youtubeUrl: 'https://www.youtube.com/shorts/74wyKVYgETU',
      ...
      { id: 'ky-h7', name: 'Banded Rainbows', difficulty: 'hard', duration: 60, emoji: '🌈', iconType: 'shoulder', youtubeUrl: 'https://www.youtube.com/shorts/uUFnCndr5JU',
...
Spine may slightly compensate (side bending)`,
    ...
    exerciseList: [
      ...
      // ── Medium ────────────────────────────────────────────────
      { id: 'us-m1', name: 'Unilateral Y Raise', difficulty: 'medium', duration: 45, emoji: '💪', iconType: 'shoulder', youtubeUrl: 'https://www.youtube.com/shorts/EuhDanbxxG4',
      ...
      { id: 'us-m3', name: 'Face Pulls', difficulty: 'medium', duration: 45, emoji: '🎯', iconType: 'shoulder', youtubeUrl: 'https://www.youtube.com/shorts/e8APCEYbpVY',
      ...
      { id: 'us-h2', name: 'Eccentric Shoulder External Rotation', difficulty: 'hard', duration: 55, emoji: '💫', iconType: 'shoulder', youtubeUrl: 'https://www.youtube.com/shorts/-KhciDzFuqU',
      ...
      { id: 'us-h3', name: 'Archer Rows', difficulty: 'hard', duration: 55, emoji: '🏹', iconType: 'back', youtubeUrl: 'https://www.youtube.com/shorts/YCjnjRQY3cU',
      ...
      { id: 'us-h4', name: 'Eccentric Reverse Fly', difficulty: 'hard', duration: 55, emoji: '🔄', iconType: 'shoulder', youtubeUrl: 'https://www.youtube.com/shorts/74wyKVYgETU',
      ...
      { id: 'us-h5', name: 'Banded Rainbows', difficulty: 'hard', duration: 60, emoji: '🌈', iconType: 'shoulder', youtubeUrl: 'https://www.youtube.com/shorts/uUFnCndr5JU',
      ...
      { id: 'us-h6', name: 'Seated Deconstructed Face Pull', difficulty: 'hard', duration: 60, emoji: '🏹', iconType: 'shoulder', youtubeUrl: 'https://www.youtube.com/shorts/drJnKgXoRQc',
