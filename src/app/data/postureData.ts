...
The head shifts forward from its natural position`,
    ...
    exerciseList: [
      ...
      { id: 'fh-h4', name: 'Neck Retraction Hold', difficulty: 'hard', duration: 55, emoji: '🧠', iconType: 'neck', youtubeUrl: 'https://www.youtube.com/shorts/p-ok89KNPCk',
        description: 'Deep neck flexor endurance hold reinforces strong head-over-spine alignment under sustained tension.',
        instructions: ['Sit or stand tall with ribs stacked over your pelvis and shoulders relaxed', 'Gently draw your chin straight back to create a clean neck retraction', 'Keep the crown of your head lifted while maintaining the retracted position', 'Hold the position while breathing steadily without shrugging', 'Release slowly, reset posture, and repeat controlled holds'] },
    ],
