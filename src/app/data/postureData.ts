...
This creates functional winging (not nerve damage, but poor control).`,
    ...
    exerciseList: [
      ...
      { id: 'ws-h8', name: 'Bear Crawl Scapular Push Up', difficulty: 'hard', duration: 55, emoji: '🐻', iconType: 'back', youtubeUrl: 'https://www.youtube.com/shorts/u7LBw4Ubaqg',
      ...
      { id: 'ws-h9', name: 'Elevated Scapular Push Up', difficulty: 'hard', duration: 60, emoji: '💪', iconType: 'back', youtubeUrl: 'https://www.youtube.com/shorts/UaKvA4qoTzw',
...
The pelvis tilts forward from its neutral position`,
    ...
    exerciseList: [
      ...
      { id: 'apt-h4', name: 'Adductor Squeeze Crunch', difficulty: 'hard', duration: 55, emoji: '💪', iconType: 'core', youtubeUrl: 'https://www.youtube.com/shorts/eGc5eLQ0KPA',
