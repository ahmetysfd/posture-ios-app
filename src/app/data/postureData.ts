...
The pelvis tilts forward from its neutral position`,
  ...
  },
  {
    ...
    exerciseList: [
      ...
      // ── Additional ────────────────────────────────────────────────
      { id: 'rs-e4', name: 'Shoulder Rockets', difficulty: 'beginner', duration: 40, emoji: '🚀', iconType: 'shoulder', youtubeUrl: 'https://www.youtube.com/shorts/Yi3VqHQd8VY',
        description: 'Activates mid and lower trapezius unilaterally, resetting each shoulder blade to its correct resting position.',
        instructions: ['Stand tall, one arm extended forward at shoulder height with a soft elbow', 'Press the arm upward and slightly back in a short arc — feel the lower trap engage', 'Hold the top position for 2 seconds without shrugging', 'Lower under full control and repeat for 10 reps on that side', 'Switch sides — focus extra time on the shoulder that feels weaker'] },
      { id: 'rs-m5', name: 'Cuffed Angels', difficulty: 'medium', duration: 40, emoji: '😇', iconType: 'shoulder', youtubeUrl: 'https://www.youtube.com/shorts/0RtxcS9F_Hk',
        description: 'Trains shoulder external rotation and scapular retraction together to directly reverse the internally-rotated rounded-shoulder posture.',
        instructions: ['Stand tall, elbows bent at 90°, upper arms against your sides', 'Externally rotate both forearms outward as far as comfortable — keep elbows pinned', 'At the end range, squeeze the shoulder blades together for 2 seconds', 'Return both forearms slowly under full control', 'Complete 12 reps — do not allow shoulders to hike throughout'] },
      { id: 'rs-h4', name: 'Banded Rainbow', difficulty: 'hard', duration: 50, emoji: '🌈', iconType: 'shoulder', youtubeUrl: 'https://www.youtube.com/shorts/uUFnCndr5JU', requiresEquipment: true,
        description: 'Dynamic overhead arc under band resistance strengthens the full rotator cuff and scapular stabilisers through a pain-free range.',
        instructions: ['Hold a resistance band with both hands, arms extended at waist height', 'Sweep both arms overhead in a wide rainbow arc, keeping tension throughout', 'At the top, pause briefly — do not let the shoulders shrug or rib cage flare', 'Return along the same arc on the opposite side to complete one rep', 'Complete 12 controlled reps — maintain scapular depression throughout the arc'] },
    ],
  ...
  },
  {
    ...
    exerciseList: [
      ...
      // ── Additional ────────────────────────────────────────────────
      { id: 'ky-e4', name: 'Thoracic Open Book', difficulty: 'beginner', duration: 35, emoji: '📖', iconType: 'back', youtubeUrl: 'https://www.youtube.com/shorts/J7f5j-rhVHc',
        description: 'Restores thoracic rotation and extension mobility in a supported side-lying position, directly countering the stiffness of kyphosis.',
        instructions: ['Lie on your side, knees stacked and bent at 90°, both arms extended forward', 'Take the top arm and rotate it slowly behind you, opening the chest toward the ceiling', 'Let your gaze and shoulder follow — keep knees together and hips still', 'Hold at the open position for 2–3 seconds, breathing into the stretch', 'Return to the start and complete 10 reps per side, starting on the stiffer side'] },
      { id: 'ky-h4', name: 'Eccentric Reverse Fly', difficulty: 'hard', duration: 50, emoji: '🦅', iconType: 'shoulder', youtubeUrl: 'https://www.youtube.com/shorts/74wyKVYgETU', requiresEquipment: true,
        description: 'Slow eccentric loading of the mid-trapezius and rhomboids builds the posterior chain endurance that keeps the thoracic spine upright.',
        instructions: ['Hold a resistance band in both hands, hinge forward 45° from hips, soft knees', 'Raise both arms out to the sides to full retraction — 1 count up', 'Lower with a full 4-second eccentric — resist the band all the way down', 'Do not let the shoulder blades wing or the lower back round during descent', 'Complete 10–12 reps — the slow lowering is the training stimulus'] },
    ],
...
Spine may slightly compensate (side bending)`,
    ...
    exerciseList: [
      ...
      // ── Additional ────────────────────────────────────────────────
      { id: 'us-e4', name: 'Overhead Shrug', difficulty: 'beginner', duration: 35, emoji: '🙌', iconType: 'shoulder', youtubeUrl: 'https://www.youtube.com/shorts/XGT4I_X_S_w',
        description: 'Trains controlled scapular elevation and depression overhead to reduce the chronic tension pattern that holds one shoulder higher.',
        instructions: ['Stand tall with both arms raised overhead, palms facing inward', 'Shrug both shoulders up toward your ears — full elevation, hold 1 second', 'Slowly depress both shoulder blades down as far as possible — hold 2 seconds', 'Feel the lower traps engage as you pull the shoulders away from the ears', 'Complete 12 reps — focus on the depressed range, not just the shrug'] },
      { id: 'us-m4', name: 'Overhead Shrug Neck Rotations', difficulty: 'medium', duration: 45, emoji: '🔄', iconType: 'shoulder', youtubeUrl: 'https://www.youtube.com/shorts/6TpTyshL2t0',
        description: 'Combines overhead scapular control with cervical rotation to simultaneously release the levator scapulae and re-educate shoulder symmetry.',
        instructions: ['Raise both arms overhead, palms facing in, and hold a light shrug position', 'Slowly rotate your head to the right while maintaining the arm position — feel the left neck stretch', 'Return to centre and rotate to the left — right neck stretches', 'Keep both shoulders at the same height throughout each rotation', 'Complete 20 slow reps (10 per direction) — breathe into each neck stretch'] },
      { id: 'us-h4', name: 'Eccentric Shoulder External Rotation', difficulty: 'hard', duration: 50, emoji: '💪', iconType: 'shoulder', youtubeUrl: 'https://www.youtube.com/shorts/-KhciDzFuqU', requiresEquipment: true,
        description: 'Slow eccentric loading of the infraspinatus and teres minor rebalances rotator cuff strength between the two shoulders.',
        instructions: ['Anchor a resistance band at elbow height and stand sideways to it', 'Hold the band in the far hand, elbow bent at 90° and pinned to your side', 'Rotate the forearm outward to full external rotation — 1 count', 'Lower back with a full 4-second eccentric, controlling the band all the way in', 'Complete 10 reps per side — spend more time on the lower shoulder side'] },
    ],
...
export const bothSideExercises: ExerciseIndexEntry[] = [
  ...
  { id: 'ky-e4', name: 'Thoracic Open Book',                             postureTypes: ['kyphosis'] },
  { id: 'ky-h2', name: 'Prone Y-Raise',                                  postureTypes: ['kyphosis'] },
  { id: 'rs-e4', name: 'Shoulder Rockets',                               postureTypes: ['rounded-shoulders'] },
  ...
  { id: 'us-h4', name: 'Eccentric Shoulder External Rotation',           postureTypes: ['uneven-shoulders'] },
];
...
export const resistanceBandExercises: ExerciseIndexEntry[] = [
  ...
  { id: 'ky-h4', name: 'Eccentric Reverse Fly',                  postureTypes: ['kyphosis'] },
  { id: 'rs-h3', name: 'Y-Pull with Band',                       postureTypes: ['rounded-shoulders'] },
  { id: 'rs-h4', name: 'Banded Rainbow',                         postureTypes: ['rounded-shoulders'] },
